...
$Script:Strings = @{
    ...
    "FR" = @{
        ...
        LblScanVersionMismatch = "TIA Portal {0} est ouvert mais la version chargee est {1}. Selectionnez {0} dans la liste des versions puis relancez le scan."
    ...
    "EN" = @{
        ...
        LblScanVersionMismatch = "TIA Portal {0} is open but the loaded version is {1}. Select {0} in the version list, then scan again."
    ...
    "ES" = @{
        ...
        LblScanVersionMismatch = "TIA Portal {0} esta abierto pero la version cargada es {1}. Seleccione {0} en la lista de versiones y vuelva a buscar."
    ...
    "IT" = @{
        ...
        LblScanVersionMismatch = "TIA Portal {0} e aperto ma la versione caricata e {1}. Seleziona {0} nell'elenco delle versioni, poi riavvia la scansione."
